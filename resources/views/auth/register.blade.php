...
<body>
    <form method="POST" action="{{route('register.submit')}}">
        @csrf
        <div
            class="bg-purple-900 absolute top-0 left-0 bg-gradient-to-b from-gray-900 via-gray-900 to-purple-800 bottom-0 h-full w-full overflow-hidden">
        </div>
        <div class="min-h-screen sm:flex sm:flex-row justify-center bg-transparent rounded-3xl">
            ...
            <div class="flex justify-center self-center z-10 shadow-lg">
                <div class="p-12 bg-white mx-auto rounded-3xl w-96">
                    <div class="mb-7">
                        <h3 class="font-semibold text-2xl text-gray-800">Sign Up</h3>
                        <p class="text-gray-400">Already have an account? <a href="/login"
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="relative" x-data="{ show: false }">
                            ...
                            <div class="flex items-center absolute inset-y-0 right-0 mr-3 text-sm leading-5">
                                ...
                                <svg @click="show = !show" :class="{'hidden': show, 'block': !show}"
                                    class="h-4 text-purple-700 cursor-pointer" fill="none"
                        ...
                        <button type="submit"
                            class="w-full p-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50"
                            onclick="return checkPasswords()">Sign Up</button>
