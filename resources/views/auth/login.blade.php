        ...
        <div class="relative   min-h-screen  sm:flex sm:flex-row  justify-center bg-transparent rounded-3xl shadow-xl">
            <div class="flex-col flex  self-center lg:px-14 sm:max-w-4xl xl:max-w-md  z-10">
                <div class="self-start hidden lg:flex flex-col  text-gray-300">
                    ...
                    <p class="pr-3 text-sm opacity-75">Halo, selamat datang di website beasiswa dimana seluruh siswa
                        dapat
                        memiliki nya</p>
                </div>
            </div>
            <div class="flex justify-center self-center  z-10">
                <div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <button type="submit"
                                class="w-full flex justify-center bg-purple-800  hover:bg-purple-700 text-gray-100 p-3  rounded-lg tracking-wide font-semibold  cursor-pointer transition ease-in duration-500">Sign
                                in</button>
                        </div>
                    ...
                    <div class="mt-7 text-center text-gray-300 text-xs">
                        <span>
                            <a href="#" rel="" target="_blank" title="Beasiswa"
                                class="text-purple-500 hover:text-purple-600 ">Beasiswa</a></span>
                    </div>
                </div>
            </div>
        </div>
